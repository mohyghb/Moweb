package com.moofficial.moweb.MoSearch;
...
public class MoSearchViewFormatter {
    ...
    public MoSearchViewFormatter setSearchBackGroundResource(int searchBackGroundResource) {
        mSearchBackGroundResource = searchBackGroundResource;
        return this;
    }

    public MoSearchViewFormatter setSearchIconResource(int searchIconResource, boolean inside, boolean outside) {
    ...
    public MoSearchViewFormatter setSearchVoiceIconResource(int searchVoiceIconResource) {
        mSearchVoiceIconResource = searchVoiceIconResource;
        return this;
    }

    public MoSearchViewFormatter setSearchTextColorResource(int searchTextColorResource) {
        mSearchTextColorResource = searchTextColorResource;
        return this;
    }

    public MoSearchViewFormatter setSearchHintColorResource(int searchHintColorResource) {
        mSearchHintColorResource = searchHintColorResource;
        return this;
    }

    public MoSearchViewFormatter setSearchHintText(String searchHintText) {
        mSearchHintText = searchHintText;
        return this;
    }

    public MoSearchViewFormatter setSearchHintTextResource(int searchHintText) {
        mSearchHintTextResource = searchHintText;
        return this;
    }

    public MoSearchViewFormatter setInputType(int inputType) {
        mInputType = inputType;
        return this;
    }

    public MoSearchViewFormatter setSearchCloseIconResource(int searchCloseIconResource) {
        mSearchCloseIconResource = searchCloseIconResource;
        return this;
    }

    public MoSearchViewFormatter setEditorActionListener(TextView.OnEditorActionListener editorActionListener) {
