...
//
////    public static final String SCRIPT_INIT_CLASS = "function initClass() {\n" +
...
//        webView.evaluateJavascript(MoJsInput.LISTENER_SCRIPT,null);
////        webView.evaluateJavascript("showE();",null);
//    }
//
//    /**
...
//        }
//
//        print(id+ " " +name + " " + type + " " + autocomplete);
//
